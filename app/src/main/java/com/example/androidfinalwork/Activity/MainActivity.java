...
//---------------actionBar
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            if(item.getItemId() == R.id.face_test){
                Intent intentMusic = new Intent(MainActivity.this,FacetestActivity.class);
                startActivity(intentMusic);
                return true;
            }else if(item.getItemId() == R.id.emotion_test){
                Intent intentVideo = new Intent(MainActivity.this,EmotiontestActivity.class);
